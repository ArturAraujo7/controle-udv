...
export default function HistoricoSessoes() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-4 text-gray-900 dark:text-white transition-colors duration-300">
      ...
      {loading ? (
        <p className="text-center text-gray-500 dark:text-gray-400 mt-10">Carregando...</p>
      ) : (
        <div className="space-y-4">
          {sessoes.map(sessao => (
            <div key={sessao.id} className="bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
              <div className="flex justify-between items-start mb-2">
                ...
                <div className="text-right">
                  <Link href={`/editar-sessao/${sessao.id}`} className="p-2 -mr-2 text-gray-400 dark:text-gray-500 hover:text-green-600 dark:hover:text-green-400 inline-block">
